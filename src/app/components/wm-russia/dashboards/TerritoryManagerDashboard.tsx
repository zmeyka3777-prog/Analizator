    ...
    return (
      <div className="space-y-6">
        ...
        <div className="wm-card bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 max-w-md flex flex-col items-center text-center gap-3">
          ...
          <p className="text-gray-400 text-sm">Загрузите свою выгрузку МДЛП в разделе «⬆️ Загрузка данных» (слева в меню). После загрузки аналитика вашей территории посчитается автоматически — обновлять страницу не нужно.</p>
        </div>
      </div>
    );
  }
