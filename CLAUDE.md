...
- MedRepDashboard полностью перестроен: 3 вкладки (продажи, динамика с помесячными графиками, KPI с radar-chart)
- TerritoryManagerDashboard расширен до 4 вкладок (добавлены: команда, сравнение, KPI)
- Обновлена память и CLAUDE.md
